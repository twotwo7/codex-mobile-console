...
const ASSETS = ['/', '/index.html', '/styles.css?v=84', '/app.js?v=96', '/message-scheduler.js?v=2', '/browser-utils.js?v=1', '/format-utils.js?v=1', '/message-utils.js?v=1', '/message-view.js?v=3', '/prompt-actions.js?v=4', '/queue-view.js?v=3', '/skill-view.js?v=3', '/manifest.json?v=2'];
